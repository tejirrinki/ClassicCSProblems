...
import sys
sys.path.insert(0,'..')
#import Chapter2SearchProblems
sys.path.append(os.path.join(os.path.dirname(__file__), '..')) 
from Chapter2SearchProblems.generic_search import bfs,Node,node_to_path
...
class Graph(Generic[V]):
    ...
    def add_vertex(self,vertex:V) ->int:
        ...
        self._edges.append([]) # add emopty list for containing edges
    ...
    def add_edge_indices(self,u:int,v:int)->None:
        edge:Edge=Edge(u,v)
        self.add_edge(edge)
    ...
    #Look up a vertice's index and find its neighbors(conveniece method)
